...
try {
		...
		const katalog = (teks) => {
             res = denz.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ⁩_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             denz.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = denz.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '919447919086-1633435866@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `${NamaBot}`, "footerText": "*_©ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ _*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
		...
		pporang = 'https://imgur.com/gallery/D858tOF'
		      }
...
const fvid = {
	 ...
	 { remoteJid: "919447919086-1633435866@g.us" } : {}) 
                },
	 message: { 
                 "videoMessage": { 
                 "title": `${tampilUcapan} ${pushname}`,
...
const finv = {
	...
	"message": {
		"groupInviteMessage": {
			"groupJid": "919447919086-1633435866@g.us",
...
denz.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
 ...
 if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Sorry it seems at this time ${NamaOwner} currently Offline\n\n*Reason :* ${alasanafk}\n*Since :* ${heheh.hours} Hour, ${heheh.minutes} Minutes, ${heheh.seconds} second\n\nPlease contact again after Online`, "*_© ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ⁩_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
		...
		const reply = (teks) => {
			denz.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ⁩`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/919656459062?text=Hi bro`}}})
		}
		const reply2 = (teks) => {
...
console.log(color('[EVAL]'), color(moment(mek.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'yellow'), color(`DEVIL V1 brooo`))
ras = budy.slice(1)
function _(rem) {
...
☯ 𝙳𝙰𝚈 : ${week} ${weton}
☯ 𝙳𝙰𝚃𝙴 : ${calender}`
sendButLocation(from, `${menu}`, "𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹⁩", {jpegThumbnail:gambar,name:""}, [
{buttonId:`allmenu`,buttonText:{displayText:'😱SHOW MENU'},type:1},
{buttonId:`owner`,buttonText:{displayText:'😎OWNER'},type:1},
{buttonId:`script`,buttonText:{displayText:'📃SCRIPT'},type:1}
...
╭─❒ 𝙱𝙾𝚃 𝙱𝚈 *ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ*
├𖣘 𝙲𝚁𝙴𝙰𝚃𝙾𝚁 : *ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ⁩*
├𖣘 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙼𝙴 : wa.me/919656459062
└❏
...
├𖣘 .othermenu
└─────────────────❒`
sendButLocation(from, `${menu}`, "ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ", {jpegThumbnail:gambar,name:""}, [{buttonId:`owner`,buttonText:{displayText:'OWNER'},type:1},{buttonId:`script`,buttonText:{displayText:'SCRIPT'},type:1}], {contextInfo: { mentionedJid: [otod]}})
break
case 'menu':
 stod = `${sender}`
 listMsg = {
 buttonText: 'ᴄʟɪᴄᴋ ʜᴇʀᴇ⁩',
 footerText: '*ꪶ͢ᴅᴇᴠɪʟꜱᴇʀꫂ⁩*',
 description: `🌺 Oiii u r alive!!! 🌺
...
├❤️⃝➤⃟̱̱̱̱̄̄̄̄🐦 ${prefix}mp3 [ _𝚁𝚎𝚙𝚕𝚢 𝚅𝚒𝚍𝚎𝚘_ ]
...
break
		...
		anu =`╭─❒ SCRIPT
│➩➬𝙱𝙰𝚂𝙴 : *ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ*
│➩➬𝙴𝚁𝚁𝙾𝚁 𝙲𝙷𝙴𝙲𝙺𝙸𝙽𝙶 : *ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ⁩*
│
└──────[ 𝚂𝙲𝚁𝙸𝙿𝚃 ]──────❒
  │➬➩ : 𝙽𝙾𝚃 𝚁𝙴𝙻𝙴𝙰𝚂𝙴𝙳 𝚈𝙴𝚃
  └──────────────────❒`
const buttons = [{buttonId: `menu`, buttonText: {displayText: 'BACK'}, type: 1},{buttonId: `owner`, buttonText: {displayText: 'OWNER'}, type: 1}]
const buttonMessage = {
    contentText: `${anu}`,
    footerText: '*_©_ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ_*',
    buttons: buttons,
...
break
		...
		try {
			  ...
			  break
case 'mode':
buttonss = [{buttonId: `public`, buttonText: {displayText: 'PUBLIC MODE'}, type: 1},{buttonId: `self`, buttonText: {displayText: 'SELF MODE'}, type: 1}]
const buMess = {
    contentText: "SELF/PUBLIC \n\n CHOOSE ONE",
    footerText: '©_ꪶ𝑫𝑬𝑽𝑰𝑳𝑺𝑬𝑹ꫂ_',
    buttons: buttonss,
    headerType: 1
}
...
denz.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: 3599996400, ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
break
case 'gemuk':
					...
					exec(`ffmpeg -i ${mediaz} -filter:a "atempo=1.6,asetrate=22100" ${ran}`, (err, stderr, stdout) => {
						...
						hah = fs.readFileSync(ran)
					denz.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, duration: 3599996400, quoted:mek})
						fs.unlinkSync(ran)
					})
					break
case 'balik':
...
if (Number(args[0]) >= 50) return reply('most!')
	...
	if (Number(args[0]) >= 50) return reply('most!')
	  for (let i = 0; i < args[0]; i++) {
	  denz.sendMessage(from, anu, audio, {mimetype: 'audio/mp4', duration: 3599996400, ptt:true})
	  }
					...
					bby.length > 300
						...
						: gtts.save(ranm, bby, function () {
							exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
								...
								denz.sendMessage(from, buff, audio, { duration: 3599996400, ptt: true, quoted: mek })
								fs.unlinkSync(rano)
							})
						})
					break
...
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						buff = await denz.downloadMediaMessage(encmedia)
						denz.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 3599996400})
						}
...
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						buff = await denz.downloadMediaMessage(encmedia)
						denz.sendMessage('status@broadcast', buff, audio, {mimetype: 'audio/mp4', duration: 3599996400, ptt: true})
						}
...
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
                    ...
                    denz.sendMessage('status@broadcast', buffer3, MessageType.video, {duration: 3599996400, caption: `${konti}`})
...
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
            ...
            case 'mp3':
					...
					exec(`ffmpeg -i ${mediad} ${ran}`, (err) => {
						...
						denz.sendMessage(from, mhee, audio, { mimetype: 'audio/mp4', duration: 3599996400, quoted: mek })
						fs.unlinkSync(ran)
					})
					break
				case 'suit':
...
break
            ...
            var options = {
                mimetype : 'audio/mp4', duration: 3599996400,
                ptt : true,
                contextInfo: { mentionedJid: mem },
                quoted: mek
            }
            ...
            var options = {
                mimetype : 'video/mp4', duration: 3599996400,
                contextInfo: { mentionedJid: mem },
                quoted: mek
            }
            ini_buffer = fs.readFileSync(file)
...
break
				...
				var bc = body.slice(6)
					...
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						buff = await denz.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							denz.sendMessage(_.jid, buff, audio, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `${bc}`, orderTitle: `${bc}`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: false}, mimetype: 'audio/mp4', duration: 3599996400, ptt: true })
						}
						} else if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
						const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						buff = await denz.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							denz.sendMessage(_.jid, buff, sticker, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 9999999999, status: 200, thumbnail: fs.readFileSync('./denz.jpg'), surface: 200, message: `${bc}`, orderTitle: `${bc}`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: false}})
							}
							} else{
